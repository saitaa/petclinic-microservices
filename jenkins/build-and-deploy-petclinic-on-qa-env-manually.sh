...
APP_NAME="petclinic"
APP_REPO_NAME="clarusway-repo/petclinic-app-qa" clarusway-repo/petclinic-app-qa"
APP_STACK_NAME="Saita-petclinic-App-QA-3"
CFN_KEYPAIR="saita-petclinic-qa.key"
